    ...
    return (
        <div className="container py-2 px-5 formulaire">
            <div className='d-flex justify-content-start'>
                <button onClick={openModal} style={{ backgroundColor: "#91725d" }} className='fs-5 my-4 p-2 text-white border-0 rounded'>Ajouter une Vente</button>
            </div>
                    ...
                    <div className='d-flex justify-content-around align-items-center'>
                        <div>
                            {isUpdating ? (
                                ...
                                <button style={{ backgroundColor: "#91725d" }} className='fs-5 my-4 p-2 text-white border-0 rounded'>
                                    Ajouter
                                </button>
                            )}
                        </div>
                        <Modal.Footer>
                            <Button variant="secondary" onClick={closeModal} className='bg-secondary text-white'>
                                Fermer
                            </Button>
                        </Modal.Footer>
                    </div>
