...
function Inscrire() {
  ...
  return (
    <div className="back shadow  d-flex justify-content-center align-items-center ">
      <form className="form">
        <div className="text-center color fs-2 m-0 fw-bold">
          {" "}
          <h2>Inscription</h2>
        </div>
        ...
        <p className="m-3 text-center">
          ...
          <span className="terms">
            {" "}
            E-delivery General Terms and Conditions{" "}
          </span>{" "}
          and acknowledge you have read the{" "}
          <span className="terms">Privacy Policy.</span>
        </p>
        <div className=" creer ">
          <Link to="/connexion" className="liens">
            {" "}
            <button
              onClick={submit}
              type="submit"
              className="creer liens fs-5 fw-bold"
            >
              Creer un compte
            </button>
          </Link>
        </div>
        <div className="d-flex  gap-4 justify-content-center inscript"></div>
      </form>
    </div>
  );
}
